...
def build_pipeline():
    ...
    model = Pipeline(steps=[
        ...
        ('classifier', RandomForestClassifier(n_estimators=100,max_depth = 15 ,random_state=42 ,  min_samples_leaf=15, min_samples_split=10 ,n_jobs=-1))
    ])
...
def main(input):
    ...
    X = data[['Sales Channel', 'Order Priority', 'Country','Units Sold', "Item Type","Region",'Unit Price', 'Unit Cost', 'Total Revenue', 'Total Cost', 'Total Profit']]
    y = data['Days to Ship']
